...
@OnlyIn(Dist.CLIENT)
public class CelebrationCreeperPowerLayer extends EnergySwirlLayer<CreeperRenderState, CelebrationCreeperModel> {
    ...
    private final CelebrationCreeperModel model;

    public CelebrationCreeperPowerLayer(RenderLayerParent<CreeperRenderState, CelebrationCreeperModel> p_174471_, EntityModelSet p_174472_) {
        super(p_174471_);
    ...
    protected CelebrationCreeperModel model() {
        return this.model;
    }
}
