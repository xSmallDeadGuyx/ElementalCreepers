...
public class GhostCreeperPowerLayer extends EnergySwirlLayer<GhostCreeper, GhostCreeperModel<GhostCreeper>> {
	...
	public GhostCreeperPowerLayer(RenderLayerParent<GhostCreeper, GhostCreeperModel<GhostCreeper>> p_174471_,
			EntityModelSet p_174472_) {
		super(p_174471_);
		this.model = new GhostCreeperModel<>(p_174472_.bakeLayer(ModelLayers.CREEPER_ARMOR));
	}
