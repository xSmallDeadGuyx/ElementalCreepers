...
public class EC_FriendlyExplosion {
	...
	public EC_FriendlyExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9) {
		worldObj = par1World;
		exploder = par2Entity;
		explosionSize = par9;
		explosionX = par3;
	 ...
	 */
	public void doExplosionA(EC_EntityFriendlyCreeper me)
	{
