...
public class EC_GhostExplosion
{
    ...
    public EC_GhostExplosion(World var1, Entity var2, double var3, double var5, double var7, float var9)
    {
        this.worldObj = var1;
        this.exploder = var2;
    ...
    public void doExplosionA()
    {
        ...
        for (int var17 = 0; var17 < var15.size(); ++var17)
        {
            ...
            if (var19 <= 1.0D)
            {
                ...
                double var25 = (1.0D - var19) * var23;
                var18.damageEntity(DamageSource.EXPLOSION, (int)((var25 * var25 + var25) / 2.0D * 8.0D * (double)this.explosionSize + 1.0D));
