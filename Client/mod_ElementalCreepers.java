...
public class mod_ElementalCreepers extends BaseModMp {
	...
	public void load() {
		...
		ModLoader.addLocalization("entity.WaterCreeper.name", "Water Creeper");
		ModLoader.addLocalization("entity.FireCreeper.name", "Fire Creeper");
		ModLoader.addLocalization("entity.IceCreeper.name", "Ice Creeper");
		ModLoader.addLocalization("entity.ElectricCreeper.name", "Electric Creeper");
		ModLoader.addLocalization("entity.EarthCreeper.name", "Earth Creeper");
		ModLoader.addLocalization("entity.PsychicCreeper.name", "Psychic Creeper");
		ModLoader.addLocalization("entity.CookieCreeper.name", "Cookie Creeper");
		ModLoader.addLocalization("entity.MagmaCreeper.name", "Magma Creeper");
		ModLoader.addLocalization("entity.FriendlyCreeper.name", "Friendly Creeper");
		ModLoader.addLocalization("entity.IllusionCreeper.name", "Illusion Creeper");
		ModLoader.addLocalization("entity.LightCreeper.name", "Light Creeper");
		ModLoader.addLocalization("entity.DarkCreeper.name", "Dark Creeper");
		ModLoader.addLocalization("entity.ReverseCreeper.name", "Reverse Creeper");
	}
